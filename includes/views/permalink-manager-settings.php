...
class Permalink_Manager_Settings extends Permalink_Manager_Class {
  ...
  public function output() {
    ...
    $output = Permalink_Manager_Admin_Functions::get_the_form($sections_and_fields, '', array('text' => __( 'Save settings', 'permalink-manager' ), 'class' => 'primary margin-top'), '', array('action' => 'save_settings', 'name' => 'permalink_manager_options'));
    return $output;
  }

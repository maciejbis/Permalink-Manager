			...
			'debug-data' => array(
				...
				'fields'       => array(
					'uris'               => array(
						...
						'value'       => ( $custom_permalinks ) ? Permalink_Manager_Debug_Functions::prepare_debug_data( $custom_permalinks ) : ''
					),
					'custom-redirects'   => array(
						...
						'input_class' => 'short-textarea widefat',
						'value'       => ( $permalink_manager_redirects ) ? Permalink_Manager_Debug_Functions::prepare_debug_data( $permalink_manager_redirects ) : ''
					),
					'external-redirects' => array(
						...
						'input_class' => 'short-textarea widefat',
						'value'       => ( $permalink_manager_external_redirects ) ? Permalink_Manager_Debug_Functions::prepare_debug_data( array_filter( $permalink_manager_external_redirects ) ) : ''
					),
					'permastructs'       => array(
						'type'        => 'textarea',
						...
						'input_class' => 'short-textarea widefat',
						'value'       => ( $permalink_manager_permastructs ) ? Permalink_Manager_Debug_Functions::prepare_debug_data( $permalink_manager_permastructs) : ''
					),
					'settings'           => array(
						'type'        => 'textarea',
						...
						'input_class' => 'short-textarea widefat',
						'value'       => Permalink_Manager_Debug_Functions::prepare_debug_data( $permalink_manager_options )
					)
				)
			)
		) );
